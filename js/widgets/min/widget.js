...
(function(global) {
    ...
    function startWidget(global, target) {
        ...
        if(refValue !== null && iFrameUrl.indexOf('ref') === -1) { iFrameUrl += "&ref="+refValue; }
        ...
        if (getLinkerParam()) { iFrameUrl += "&" + getLinkerParam(); }
    ...
    if(window.ga) {
        window.ga(function (tracker) {
            ...
            setTimeout(() => {
                    frameWindow.postMessage({gaClientId: clientId}, "https://www.tickettailor.com/");
                },
